...
//!   --all-local              test full production chain: gemma4 → glm-ocr → moondream → qwen2-vl:2b + remote
    ...
    while let Some(arg) = args.next() {
        match arg.as_str() {
            ...
            "--all-local" => {
                ...
                // moondream (lightweight vision), qwen2-vl:2b (vision-language).
                ...
                if models.len() == 1 {
                    ...
                    models.push("qwen2-vl:2b".to_string());
                }
